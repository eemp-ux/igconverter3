        ...
        <div className="space-y-6">
          <section>
            <div className="flex items-baseline gap-2 mb-3">
              ...
              <h2 className="text-2xl font-bold text-white">Ideal Gas Law</h2>
            </div>
            <IdealGasLaw />
          </section>
          ...
          <section>
            <div className="flex items-baseline gap-2 mb-3">
              ...
              <h2 className="text-2xl font-bold text-white">Gas Volume Conversion Guide</h2>
            </div>
          ...
          <section>
            <div className="flex items-baseline gap-2 mb-3">
              ...
              <h2 className="text-2xl font-bold text-white">Understanding Gas Pricing</h2>
            </div>
